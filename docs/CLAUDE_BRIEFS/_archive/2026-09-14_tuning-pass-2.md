...
**Status:** DONE (Claude Code, 2026-09-14, PR #56 `feat(balance): sustain retune + boss dmg cap, Hearth rename, recipes/floor/afk tuning table`; final boss hp ×62 / dmg ×7) · **Date:** 2026-09-14 · **Author:** Claude Design Chat · **Spec:** `Eldrathor_Progression_Loop_Lock.md` §9, `Eldrathor_Combat_v2_Lock.md` (retuned rows)
