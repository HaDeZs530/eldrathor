...
**Status:** DONE (Claude Code, 2026-09-14, PR #55 `fix(ui): sheets and cards inherit screen mode`) · **Date:** 2026-09-14 · **Author:** Claude Design Chat · **Spec:** `Eldrathor_Style_Bible_Lock.md` §D
