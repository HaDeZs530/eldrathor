...
**Status:** DONE (Claude Code, 2026-09-14, PR #53 `feat(afk): true idle accrual + offline summary`) · **Date:** 2026-09-14 · **Author:** Claude Design Chat · **Spec:** `docs/Eldrathor_Progression_Loop_Lock.md` §6
