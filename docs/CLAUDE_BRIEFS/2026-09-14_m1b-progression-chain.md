...
**Status:** DONE (Claude Code, 2026-09-14, PR #51 `feat(progression): xp, equipment, empowerment, armor, rarity ladder, crit fix, balance gates`) · **Date:** 2026-09-14 · **Author:** Claude Design Chat · **Spec:** `docs/Eldrathor_Progression_Loop_Lock.md` §2–§5, §7
