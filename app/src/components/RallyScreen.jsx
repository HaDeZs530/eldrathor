...
const S = {
  ...
  sub: { fontSize: 'var(--mv-label, 15px)', color: 'var(--eld-muted)', marginTop: 4, lineHeight: 1.4 },
  lore: { padding: 14 },
  loreText: { fontSize: 'var(--mv-text, 18px)', lineHeight: 1.5, fontStyle: 'italic', color: 'var(--eld-text)' },
  panel: { padding: 14, flex: '0 0 auto' },
  panelLbl: { fontSize: 'var(--mv-label, 15px)', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--eld-muted)', marginBottom: 8 },
  list: { display: 'flex', flexDirection: 'column', gap: 8 },
  member: { padding: '10px 12px', borderLeft: '3px solid', textAlign: 'left', width: '100%', color: 'inherit', fontFamily: 'inherit', cursor: 'pointer', position: 'relative', minHeight: 'var(--mv-tap, 52px)' },
  ...
  sheetTitle: { fontSize: 'var(--mv-label, 15px)', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--eld-muted)', marginBottom: 10 },
  empty: { fontSize: 'var(--mv-label, 15px)', color: 'var(--eld-muted)', fontStyle: 'italic', marginBottom: 8 },
};
