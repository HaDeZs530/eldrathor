...
const S = {
  ...
  head: { flexShrink: 0 },
  kick: { fontSize: 'var(--mv-label, 15px)', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#5f8494', fontFamily: 'var(--eld-font-display, Cinzel, Georgia, serif)' },
  ...
  line: { fontSize: 'var(--mv-text, 18px)', lineHeight: 1.45, color: '#cfe0e8' },
  ...
  memberMeta: { fontSize: 'var(--mv-label, 15px)', color: '#7fd6a0' },
  secLbl: { fontSize: 'var(--mv-label, 15px)', letterSpacing: '0.14em', textTransform: 'uppercase', color: '#5f8494' },
