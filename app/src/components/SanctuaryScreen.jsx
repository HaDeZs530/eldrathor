  ...
  return (
    <div style={S.wrap}>
      <div style={S.head}>
        ...
        <div className="eld-brand-name" style={S.title}>A wild healing crystal</div>
...
const S = {
  ...
  head: { flexShrink: 0 },
  kick: { fontSize: 'var(--mv-label, 13px)', letterSpacing: '0.22em', textTransform: 'uppercase', color: '#5f8494', fontFamily: 'var(--eld-font-display, Cinzel, Georgia, serif)' },
  title: { fontSize: 20, fontWeight: 700, marginTop: 4, color: '#bfffe0', textShadow: '0 0 16px rgba(127,214,160,0.5)' },
  sub: { fontSize: 'var(--mv-label, 13px)', color: '#5f8494', marginTop: 4, fontStyle: 'italic' },
  ...
  line: { fontSize: 'var(--mv-text, 16px)', lineHeight: 1.45, color: '#cfe0e8' },
  ...
  memberName: { fontSize: 'var(--mv-text, 16px)', fontWeight: 700 },
  memberMeta: { fontSize: 'var(--mv-label, 13px)', color: '#7fd6a0' },
  secLbl: { fontSize: 'var(--mv-label, 13px)', letterSpacing: '0.14em', textTransform: 'uppercase', color: '#5f8494' },
  choices: { display: 'flex', flexDirection: 'column', gap: 8 },
  choice: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 2, padding: '12px 14px', minHeight: 'var(--mv-tap, 48px)', textAlign: 'left' },
  choiceGlyph: { fontSize: 18 },
  choiceLabel: { fontSize: 'var(--mv-text, 16px)', fontWeight: 700 },
  choiceBlurb: { fontSize: 'var(--mv-label, 13px)', opacity: 0.8, textTransform: 'none', letterSpacing: 0, fontFamily: 'var(--eld-font-body, system-ui, sans-serif)' },
};
