...
const S = {
  ...
  pcardWeapon: { fontSize: 11, color: 'var(--eld-muted, #7f97a3)', marginTop: 6 },
  pcardLvl: { fontSize: 10, color: 'var(--eld-muted, #5f8494)', marginTop: 4 },
  ...
  rating: { color: 'var(--eld-muted, #5f8494)', fontVariantNumeric: 'tabular-nums' },
  ...
  editLbl: { fontSize: 10, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--eld-muted, #5f8494)', display: 'block', margin: '8px 0 4px' },
  select: { width: '100%', background: 'rgba(0,0,0,0.3)', border: '1px solid var(--eld-border, #1c3a44)', color: 'inherit', borderRadius: 6, padding: '8px 10px', fontSize: 13, boxSizing: 'border-box' },
  archBlurb: { fontSize: 11, color: 'var(--eld-muted, #6f8794)', fontStyle: 'italic', marginTop: 6 },
  statRow: { display: 'flex', justifyContent: 'space-between', marginTop: 12, fontSize: 11, color: 'var(--eld-muted, #7f97a3)', fontVariantNumeric: 'tabular-nums' },
};
