...
const S = {
  ...
  title: { fontSize: 'var(--mv-title, 26px)', fontWeight: 700, marginTop: 4, color: 'var(--eld-text, #e6f2f7)' },
  ...
  statK: { fontSize: 'var(--mv-label, 15px)', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--eld-muted, #5f8494)' },
  statV: { fontSize: 'var(--mv-num, 24px)', fontWeight: 700, marginTop: 4, color: 'var(--eld-accent, #5fc7e0)' },
  veinRow: {
    display: 'flex',
  ...
  note: { fontSize: 'var(--mv-label, 15px)', color: 'var(--eld-muted, #5f8494)', fontStyle: 'italic', marginBottom: 10 },
  ...
  cost: { fontSize: 'var(--mv-text, 18px)', color: 'var(--eld-muted, #5f8494)', fontVariantNumeric: 'tabular-nums' },
  upName: { fontSize: 'var(--mv-text, 18px)', fontWeight: 700 },
  upBlurb: { fontSize: 'var(--mv-text, 18px)', color: 'var(--eld-muted, #7f97a3)', marginTop: 4, lineHeight: 1.4 },
